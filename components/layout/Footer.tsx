...
const socials = [
  { label: 'GitHub', href: 'https://github.com/ThinhVinhPhat', icon: GitHubIcon },
  { label: 'Facebook', href: 'https://www.facebook.com/phat.thinhvinh.7/', icon: FacebookIcon },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/th%C3%ACnh-v%C4%A9nh-ph%C3%A1t-aaa865338/', icon: LinkedInIcon },
]
